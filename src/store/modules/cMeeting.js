const cMeeting = {
    ...
    actions: {
      list_cMeeting: function ({
        ...
        vm.$http.post('/api/cMeeting/list',param).then((res) => {
      ...
      page_cMeeting: function ({
         ...
         let vm=this._vm;
                 return new Promise(function (resolve, reject) {
         vm.$http.post('/api/cMeeting/page',param).then((res) => {
      ...
      save_cMeeting: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/cMeeting/save', state.cMeeting).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
      ...
      update_cMeeting: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/cMeeting/update', state.cMeeting).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
      ...
      del_cMeeting: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/cMeeting/logicDel', param).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
      ...
      get_cMeeting: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/cMeeting/get', param).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
