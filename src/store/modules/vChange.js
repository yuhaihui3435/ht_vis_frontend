const vChange = {
    ...
    actions: {
      list_vChange: function ({
        ...
        vm.$http.post('/api/vChange/list',param).then((res) => {
      ...
      page_vChange: function ({
         ...
         let vm=this._vm;
                 return new Promise(function (resolve, reject) {
         vm.$http.post('/api/vChange/page',param).then((res) => {
      ...
      save_vChange: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/vChange/save', state.vChange).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
      ...
      update_vChange: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/vChange/update', state.vChange).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
      ...
      del_vChange: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/vChange/logicDel', param).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
      ...
      get_vChange: function ({
        ...
        state
          ...
          let vm=this._vm;
        return new Promise(function (resolve, reject) {
          vm.$http.post('/api/vChange/get', param).then((res) => {
              resolve(res)
          }).catch((res)=>{
                      reject(res)
                    });
